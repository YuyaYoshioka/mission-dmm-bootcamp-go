...
type (
	...
	Dao interface {
		...
		//Get timeline_public repository
		TimelinesPublic() repository.TimelinesPublic
...
func (d *dao) TimelinesPublic() repository.TimelinesPublic {
	return NewTimelinesPublic(d.db)
}
